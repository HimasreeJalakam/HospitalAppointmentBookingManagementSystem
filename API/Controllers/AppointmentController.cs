...

{
    ...
    [HttpPut("update-past-status")]

    public IActionResult UpdatePastAppointmentsStatus()

    {

        _appointmentService.UpdatePastAppointmentsStatus();

        return Ok("Past appointments updated successfully.");
